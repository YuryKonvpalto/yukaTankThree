...
class T34Vehicle extends YUKA.Vehicle {
    ...
    setBulletOnStart() {
        ...
        this._renderComponent.children[0].children[4].children[0].children[0].getWorldPosition(helperVector3) //gets position of gun's muzzle and copies it to helperVector
    ...
    start() {
        ...
        this.fireCube = this._renderComponent.children[0].children[4].children[0].children[0]
    }
    ...
    checkHitSpot(entity) {//checks how badly target has been hit
        ...
        if (entity.side === this.enemySide) {
            ...
            if (dot < -0.80) {/// front of enemy has been hit
                ...
                entity.lifePoints -= THREE.MathUtils.randFloat(25, 60) * distCoeff///enemy side has been hit

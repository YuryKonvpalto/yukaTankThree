...
import explode4 from "../../../../../img/PanzerGame/particlesImg/explode4.png";
import explode5 from "../../../../../img/PanzerGame/particlesImg/explos5.png";
import explode2 from "../../../../../img/PanzerGame/particlesImg/explodeRed2.png";
import explode3 from "../../../../../img/PanzerGame/particlesImg/plane.png";
...
class ExplodeEmitter extends Emitter {
    ...
    constructor() {
        ...
        super({
            ...
            // texture: [new THREE.TextureLoader().load(explode1), new THREE.TextureLoader().load(explode4),
            // new THREE.TextureLoader().load(explode5)],
            texture: new THREE.TextureLoader().load(explode5),
            size: 45,
            sizeRange: 100,
            // sizeTween: new Tween([0, 0.01, 0.1, .95], [0, 8, 145, 18]),
            sizeTween: new Tween([0, 0.01, 0.1, .95], [0, 150, 245, 168]),
            opacityTween: new Tween([0, 0.01, 0.1, 0.95], [1, 1, 0.4, 0]),
            color: new THREE.Vector3(0.75, 0.3, 0.8),
            colorRange: new THREE.Vector3(1, 0.5, 0.3),

            // blendMode: THREE.AdditiveBlending,
            particlesPerSecond: 10,
            // particleDeathAge: 0.12,
            particleDeathAge: 0.11,

...
class ExplodeEmitter extends Emitter {
    ...
    constructor() {
        ...
        super({
            ...
            size: 45,
            sizeRange: 100,
            sizeTween: new Tween([0, 0.01, 0.1, .95], [0, 140, 205, 98]),
            opacityTween: new Tween([0, 0.01, 0.1, 0.95], [1, 1, 0.5, 0]),
            color: new THREE.Vector3(0.15, 0.1, 0.7),
            colorRange: new THREE.Vector3(0.4, 0.4, 0.3),

            // blendMode: THREE.AdditiveBlending,
            particlesPerSecond: 11,
            particleDeathAge: 0.30,
